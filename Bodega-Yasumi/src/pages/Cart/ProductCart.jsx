...
const ProductCart = ({
  ...
  return (
    <div className="py-5 sm:py-8 w-[30rem]">
        <div className="flex flex-row gap-4 lg:gap-6 sm:py-2.5 justify-between">
            <section className='flex gap-4'>     
                ...
                <div className="flex flex-col justify-between flex-1">
                    ...
                    <span className="block text-lg text-gray-500">{`Precio: s/${precio}`}</span>
                    <span className="block text-lg text-gray-500">{`Cantidad: ${qty} unidades`}</span>
                    </div>
            ...
            <div className="sm:w-auto flex justify-between border-t sm:border-none pt-4 sm:pt-0">
